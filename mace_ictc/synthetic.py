...
Usage:
  python -m mace_ictc.test.bench_ictd_fix_trainstep --check
  python -m mace_ictc.test.bench_ictd_fix_trainstep --check --save-ref /tmp/ref.pt
  python -m mace_ictc.test.bench_ictd_fix_trainstep --check --compare-ref /tmp/ref.pt
  python -m mace_ictc.test.bench_ictd_fix_trainstep --bench --atoms 512 --profile
"""
...
def run_paths(args) -> int:
    ...
    from mace_ictc.models.ictd_irreps import ictd_u_matrix_so3
    lmax = args.lmax
